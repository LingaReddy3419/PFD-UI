...
import com.ada.pfd.repository.ImageRepository;
...
class ImageResourceIT {
    ...
    public static Image createEntity(EntityManager em) {
        Image image = new Image().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).fileName(DEFAULT_FILE_NAME).url(DEFAULT_URL);
        return image;
    }
    ...
    public static Image createUpdatedEntity(EntityManager em) {
        Image image = new Image().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).fileName(UPDATED_FILE_NAME).url(UPDATED_URL);
        return image;
    }
    ...
    void putExistingImage() throws Exception {
        ...
        updatedImage.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).fileName(UPDATED_FILE_NAME).url(UPDATED_URL);
    ...
    void partialUpdateImageWithPatch() throws Exception {
        ...
        partialUpdatedImage.title(UPDATED_TITLE);
    ...
    void fullUpdateImageWithPatch() throws Exception {
        ...
        partialUpdatedImage.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).fileName(UPDATED_FILE_NAME).url(UPDATED_URL);
