...
import com.ada.pfd.domain.Video;
import com.ada.pfd.repository.VideoRepository;
...
class VideoResourceIT {
    ...
    public static Video createEntity(EntityManager em) {
        Video video = new Video().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).fileName(DEFAULT_FILE_NAME).url(DEFAULT_URL);
        return video;
    }
    ...
    public static Video createUpdatedEntity(EntityManager em) {
        Video video = new Video().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).fileName(UPDATED_FILE_NAME).url(UPDATED_URL);
        return video;
    }
    ...
    void putExistingVideo() throws Exception {
        ...
        updatedVideo.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).fileName(UPDATED_FILE_NAME).url(UPDATED_URL);
    ...
    void partialUpdateVideoWithPatch() throws Exception {
        ...
        partialUpdatedVideo.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).url(UPDATED_URL);
    ...
    void fullUpdateVideoWithPatch() throws Exception {
        ...
        partialUpdatedVideo.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).fileName(UPDATED_FILE_NAME).url(UPDATED_URL);
