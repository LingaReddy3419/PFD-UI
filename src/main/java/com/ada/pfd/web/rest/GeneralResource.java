...
/**
 * REST controller for managing {@link com.ada.pfd.domain.General}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class GeneralResource {
    ...
    public ResponseEntity<General> createGeneral(@RequestBody General general) throws URISyntaxException {
    ...
    public ResponseEntity<General> updateGeneral(@PathVariable(value = "id", required = false) final Long id, @RequestBody General general)
    ...
    public ResponseEntity<General> partialUpdateGeneral(
        ...
        Optional<General> result = generalRepository
