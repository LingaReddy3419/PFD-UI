...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPERATIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_OPERATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OPERATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OPERATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OPERATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OPERATIONS actions', async () => {
      const expectedActions = [
        {
