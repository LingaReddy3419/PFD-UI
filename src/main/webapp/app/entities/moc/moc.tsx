...
export const MOC = () => {
  ...
  return (
    <div>
      <h4 id="moc-heading" data-cy="MOCHeading">
            ...
            <tbody>
              {mOCList.map((mOC, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="font-size">{mOC.title}</td>
                  <td className="font-size">{mOC.description}</td>
                  <td className="text-end buttons-padding">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/moc/${mOC.id}`} size="sm" data-cy="entityDetailsButton" className="table-icon green">
                        <FontAwesomeIcon icon="eye" />{' '}
                        {/* <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.view">View</Translate>
                        </span> */}
                      </Button>
                      <Button tag={Link} to={`/moc/${mOC.id}/edit`} size="sm" data-cy="entityEditButton" className="table-icon blue">
                        <FontAwesomeIcon icon="pencil-alt" />{' '}
                        {/* <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.edit">Edit</Translate>
                        </span> */}
                      </Button>
                      <Button tag={Link} to={`/moc/${mOC.id}/delete`} size="sm" data-cy="entityDeleteButton" className="table-icon red">
