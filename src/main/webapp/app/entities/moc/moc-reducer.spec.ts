...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './moc.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MOC_LIST actions', async () => {
    ...
    it('dispatches FETCH_MOC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MOC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MOC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MOC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MOC actions', async () => {
      const expectedActions = [
        {
