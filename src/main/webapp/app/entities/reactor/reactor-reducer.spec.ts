...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './reactor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REACTOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_REACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REACTOR actions', async () => {
      const expectedActions = [
        {
