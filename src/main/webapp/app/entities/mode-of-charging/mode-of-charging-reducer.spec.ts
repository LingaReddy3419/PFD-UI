...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MODEOFCHARGING_LIST actions', async () => {
    ...
    it('dispatches FETCH_MODEOFCHARGING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MODEOFCHARGING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MODEOFCHARGING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MODEOFCHARGING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MODEOFCHARGING actions', async () => {
      const expectedActions = [
        {
