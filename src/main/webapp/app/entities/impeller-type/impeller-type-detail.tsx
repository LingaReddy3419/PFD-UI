      ...
      <Row>
        <Col md="12">
          <h2 data-cy="impellerTypeDetailsHeading">
            <h4 className="table-view-edit-heading">
              {' '}
          ...
          <div className="table-edit-form-container">
            ...
            <div className="table-buttons-container">
              <Button className="border-radius" tag={Link} to="/impeller-type" replace color="secondary" data-cy="entityDetailsBackButton">
              ...
              &nbsp;
              <Button className="border-radius" tag={Link} to={`/impeller-type/${impellerTypeEntity.id}/edit`} replace color="warning">
