    ...
    <div>
      <h2 id="impeller-type-heading" data-cy="ImpellerTypeHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to="/impeller-type/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            <tbody>
              {impellerTypeList.map((impellerType, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{impellerType.title}</td>
                  <td>{impellerType.description}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/impeller-type/${impellerType.id}`} color="info" size="sm" data-cy="entityDetailsButton">
                        <FontAwesomeIcon icon="eye" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.view">View</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`/impeller-type/${impellerType.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
