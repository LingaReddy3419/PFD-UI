...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMPELLERTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_IMPELLERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IMPELLERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IMPELLERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IMPELLERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IMPELLERTYPE actions', async () => {
      const expectedActions = [
        {
