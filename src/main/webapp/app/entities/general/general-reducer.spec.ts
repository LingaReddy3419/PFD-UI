...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './general.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENERAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_GENERAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GENERAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GENERAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GENERAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GENERAL actions', async () => {
      const expectedActions = [
        {
